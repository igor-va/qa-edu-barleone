...
class BasePage:
    ...
    def action_click(self, element):
        WebDriverWait(self.driver, self.timeout).until(EC.invisibility_of_element_located(BaseLocators.loc_xpath_obscure_preloader))
    ...
    def wait_load_element(self, element):
        WebDriverWait(self.driver, self.timeout).until(EC.invisibility_of_element_located(element))
